...
public class CMunicipios implements Initializable {
    //columnas tabla
    @FXML
    private TableColumn<MMunicipios, Integer> clCod;
    @FXML
    private TableColumn<MMunicipios, String> clDes;
    //Componentes GUI
    @FXML
    ...
    @FXML
    private TableView<MMunicipios> tb_principal;

    public enum Acciones{

    }
    //collecion
    ObservableList<MMunicipios> listaTbMun;
    //Logger
    private static final Logger LOGGER = LoggerFactory.getLogger(CMunicipios.class.getSimpleName());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //llamar metodos
        MMunicipios.obtenerInfoMun(conexion.getConnection(), listaTbMun);
        //cargar tabla
        tb_principal.setItems(listaTbMun);
        //Enlazar columnas con atributos
        clCod.setCellValueFactory(new PropertyValueFactory<MMunicipios, Integer>("codMun"));
        clDes.setCellValueFactory(new PropertyValueFactory<MMunicipios, String>("desMun"));
        //Eventos
        gestionar_eventos();
        //cerrar conexion
    ...
    public void gestionar_eventos() {
        tb_principal.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<MMunicipios>() {
            @Override
            public void changed(ObservableValue<? extends MMunicipios> observableValue, MMunicipios valorAnterior, MMunicipios valorSeleccionado) {
    ...
    public void guardarRegistro() {
        ...
        //crea una nueva instancia del tipo municipio
        MMunicipios a = new MMunicipios(ultCod(), txt_des.getText());
        //llamar al metodo guardar de la clase municipio
        //abre conexion
        if(validacion() == false){
            LOGGER.info("Campos no validos");
        } else {
            conexion.iniciarConexion();
    ...
    public void editarRegistro() {
        ...
        MMunicipios a = new MMunicipios(Integer.valueOf(txt_cod.getText()), txt_des.getText());
        if(validacion() == false){
            LOGGER.info("Se ha precionado el boton editar");
        } else {
            //abre conexion
    ...
    public void busqueda() {
        ...
        MMunicipios.busquedaInfoMun(conexion.getConnection(),listaTbMun, filtro);
        //cerrar conexion
        conexion.cerrarConexion();
    }
    ...
    public void imprimir(){
        (new Thread(){
            public void run(){
                String rt = CMunicipios.this.getClass().getSimpleName();
