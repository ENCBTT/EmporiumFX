...
public class CClientesD implements Initializable {

    CClientesD CclientesD;
    CFacturas Cfacturas;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //llamar metodos
        MPersonas.obtenerInfoMun(conexion.getConnection(), listatbBusqueda);
    ...
    public void busqueda2() {
       ...
       // String part1 = parts[0];
        ...
        MPersonas.busquedaClientesD(conexion.getConnection(),listatbBusqueda, des);
        tb_proD.setItems(listatbBusqueda);
        //cerrar conexion
        conexion.cerrarConexion();
    }
