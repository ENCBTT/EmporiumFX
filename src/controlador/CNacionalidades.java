...
public class CNacionalidades implements Initializable {
    //columnas tabla
    @FXML
    private TableColumn<MNacionalidades, Integer> clCod;
    @FXML
    private TableColumn<MNacionalidades, String> clDes;
    //Componentes GUI
    @FXML
    ...
    @FXML
    private TableView<MNacionalidades> tb_principal;

    //collecion
    ObservableList<MNacionalidades> listaTbMun;
    //Logger
    private static final Logger LOGGER = LoggerFactory.getLogger(CNacionalidades.class.getSimpleName());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //llamar metodos
        MNacionalidades.obtenerInfoMun(conexion.getConnection(), listaTbMun);
        //cargar tabla
        tb_principal.setItems(listaTbMun);
        //Enlazar columnas con atributos
        clCod.setCellValueFactory(new PropertyValueFactory<MNacionalidades, Integer>("codMun"));
        clDes.setCellValueFactory(new PropertyValueFactory<MNacionalidades, String>("desMun"));
        //Eventos
        gestionar_eventos();
        //cerrar conexion
    ...
    public void gestionar_eventos() {
        tb_principal.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<MNacionalidades>() {
            @Override
            public void changed(ObservableValue<? extends MNacionalidades> observableValue, MNacionalidades valorAnterior, MNacionalidades valorSeleccionado) {
    ...
    public void guardarRegistro() {
        ...
        //crea una nueva instancia del tipo nacionalidad
        MNacionalidades a = new MNacionalidades(ultCod(), txt_des.getText());
        ...
        if(!validacion()){
            ...
            //abre conexion
            conexion.iniciarConexion();
            //llamar al metodo guardar de la clase nacionalidad
    ...
    public void editarRegistro() {
        Alert mensaje = new Alert(Alert.AlertType.INFORMATION);
        //crea una nueva instancia del tipo nacionalidad
        MNacionalidades a = new MNacionalidades(Integer.valueOf(txt_cod.getText()), txt_des.getText());
    ...
    public int ultCod(){
        //abre conexion
        conexion.iniciarConexion();
        MNacionalidades m = new MNacionalidades();
    ...
    public void busqueda() {
        ...
        MNacionalidades.busquedaInfoMun(conexion.getConnection(),listaTbMun, filtro);
        //cerrar conexion
        conexion.cerrarConexion();
    ...
    public void imprimir(){
        (new Thread(() -> {
            String rt = CNacionalidades.this.getClass().getSimpleName();
