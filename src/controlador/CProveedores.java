...
public class CProveedores implements Initializable {
    //columnas tabla
    @FXML
    private TableColumn<MProveedores, Integer> clCod;
    @FXML
    private TableColumn<MProveedores, String> clDes;
    //Componentes GUI
    @FXML
    ...
    @FXML
    private TableView<MProveedores> tb_principal;

    public enum Acciones{

    }
    //collecion
    ObservableList<MProveedores> listaTbMun;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //llamar metodos
        MProveedores.obtenerInfoMun(conexion.getConnection(), listaTbMun);
        //cargar tabla
        tb_principal.setItems(listaTbMun);
        //Enlazar columnas con atributos
        clCod.setCellValueFactory(new PropertyValueFactory<MProveedores, Integer>("codMun"));
        clDes.setCellValueFactory(new PropertyValueFactory<MProveedores, String>("desMun"));
        //Eventos
        gestionar_eventos();
        //cerrar conexion
    ...
    public void gestionar_eventos() {
        tb_principal.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<MProveedores>() {
            @Override
            public void changed(ObservableValue<? extends MProveedores> observableValue, MProveedores valorAnterior, MProveedores valorSeleccionado) {
                if (valorSeleccionado != null) {
                    txt_cod.setText(String.valueOf(valorSeleccionado.getCodPro()));
                    txt_des.setText(valorSeleccionado.getDesPro());
    ...
    public void guardarRegistro() {
        ...
        MProveedores a = new MProveedores(ultCod(), txt_des.getText(), ""); // ingresa en la tabla com codigo 0, como solucionar? SOLUCIONADO
        //llamar al metodo guardar de la clase proveedores
        //abre conexion
        if(validacion() == false){
    ...
    public void editarRegistro() {
        ...
        MProveedores a = new MProveedores(Integer.valueOf(txt_cod.getText()), txt_des.getText(), "");
        if(validacion() == false){
    ...
    public int ultCod(){
        //abre conexion
        conexion.iniciarConexion();
        MProveedores m = new MProveedores();
    ...
    public void busqueda() {
        ...
        MProveedores.buscarRegistro(conexion.getConnection(),listaTbMun, filtro);
        //cerrar conexion
        conexion.cerrarConexion();
