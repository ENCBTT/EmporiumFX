...
public class CLocalidades implements Initializable {
    //columnas tabla
    @FXML
    private TableColumn<MLocalidades, Integer> clCod;
    @FXML
    private TableColumn<MLocalidades, String> clDes;
    //Componentes GUI
    @FXML
    ...
    @FXML
    private TableView<MLocalidades> tb_principal;
    
    //collecion
    ObservableList<MLocalidades> listaTbMun;
    //Logger
    private static final Logger LOGGER = LoggerFactory.getLogger(CLocalidades.class.getSimpleName());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //llamar metodos
        MLocalidades.obtenerInfoMun(conexion.getConnection(), listaTbMun);
        //cargar tabla
        tb_principal.setItems(listaTbMun);
        //Enlazar columnas con atributos
        clCod.setCellValueFactory(new PropertyValueFactory<MLocalidades, Integer>("codMun"));
        clDes.setCellValueFactory(new PropertyValueFactory<MLocalidades, String>("desMun"));
        //Eventos
        gestionar_eventos();
        //cerrar conexion
    ...
    public void gestionar_eventos() {
        tb_principal.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<MLocalidades>() {
            @Override
            public void changed(ObservableValue<? extends MLocalidades> observableValue, MLocalidades valorAnterior, MLocalidades valorSeleccionado) {
    ...
    public void guardarRegistro() {
        ...
        //crea una nueva instancia del tipo localidad
        MLocalidades a = new MLocalidades(ultCod(), txt_des.getText());
        ...
        if(!validacion()){
            ...
            //abre conexion
            conexion.iniciarConexion();
            //llamar al metodo guardar de la clase localidad
    ...
    public void editarRegistro() {
        Alert mensaje = new Alert(Alert.AlertType.INFORMATION);
        //crea una nueva instancia del tipo localidad
        MLocalidades a = new MLocalidades(Integer.valueOf(txt_cod.getText()), txt_des.getText());
    ...
    public int ultCod(){
        //abre conexion
        conexion.iniciarConexion();
        MLocalidades m = new MLocalidades();
    ...
    public void busqueda() {
        ...
        MLocalidades.busquedaInfoMun(conexion.getConnection(),listaTbMun, filtro);
        //cerrar conexion
        conexion.cerrarConexion();
    }
    ...
    public void imprimir(){
        (new Thread(() -> {
            String rt = CLocalidades.this.getClass().getSimpleName();
